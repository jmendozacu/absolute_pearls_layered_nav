...
class Amasty_Base_Model_Conflicts{
    ...
    public function __construct() {
        ...
        $this->_amastyDir    = array(
            $this->_codeDir . DS . 'local' . DS . 'Amasty',
            $this->_codeDir . DS . 'local' . DS . 'Belitsoft',
            $this->_codeDir . DS . 'community' . DS . 'MagePlace',
        );
...
//            $testObj->getCacheConfig();
    ...
    protected function checkFilePermissions() {
        ...
        $this->checkPermissions($this->_etcDir . DS . 'modules', 'Belitsoft_');
        $this->checkPermissions($this->_etcDir . DS . 'modules', 'Mageplace_');
        foreach($this->_amastyDir as $amaDir){
            $this->checkPermissions($amaDir);
        }
